# [Ω Olympus Frontend](https://app.hectordao.com/)
...
```bash
$ git clone https://github.com/HectorDAO/olympusdao.git
$ cd olympusdao
...
| Branch | URL |
| --- | --- |
| master | https://app.hectordao.com |
| deploy | https://staging.app.hectordao.com |
...
We keep an updated list of bugs/feature requests in [Github Issues](https://github.com/HectorDAO/olympusdao/issues). 


![GitHub issues](https://img.shields.io/github/issues/olympusdao/olympusdao?style=flat-square)

Filter by ["good first issue"](https://github.com/HectorDAO/olympusdao/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) to get your feet wet!
